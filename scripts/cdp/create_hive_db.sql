CREATE DATABASE IF NOT EXISTS worldwidebank LOCATION 's3a://jon-emr2cdp/raw/wwbankdata/rawzone/worldwidebank';
...
CREATE EXTERNAL TABLE IF NOT EXISTS worldwidebank.ww_customers(
                                  ...
                                  STORED AS TEXTFILE
                                  LOCATION 's3a://jon-emr2cdp/raw/wwbankdata/rawzone/worldwidebank/ww_customers' 
...
CREATE EXTERNAL TABLE IF NOT EXISTS worldwidebank.us_customers(
                                  ...
                                  , Longitude            DOUBLE
                                   ...
                                   FIELDS TERMINATED BY ','
                                   STORED AS TEXTFILE
                                   LOCATION 's3a://jon-emr2cdp/raw/wwbankdata/rawzone/worldwidebank/us_customers'
                                   tblproperties("skip.header.line.count"="1");
...
CREATE EXTERNAL TABLE IF NOT EXISTS worldwidebank.eu_countries (
                                  ...
                                  , Region STRING
                                   ...
                                   FIELDS TERMINATED BY ','
                                   STORED AS TEXTFILE
                                   LOCATION 's3a://jon-emr2cdp/raw/wwbankdata/rawzone/eu_countries';


CREATE DATABASE IF NOT EXISTS finance LOCATION 's3a://jon-emr2cdp/raw/wwbankdata/rawzone/finance';
...
CREATE EXTERNAL TABLE IF NOT EXISTS finance.tax_2009 (
                                  ...
                                  , local_tax INT
                                   ...
                                   FIELDS TERMINATED BY ','
                                   STORED AS TEXTFILE
                                   LOCATION 's3a://jon-emr2cdp/raw/wwbankdata/rawzone/finance/tax_2009';
...
CREATE EXTERNAL TABLE IF NOT EXISTS finance.tax_2010 (
                                 ...
                                 , local_tax INT
                                  ...
                                  FIELDS TERMINATED BY ','
                                  STORED AS TEXTFILE
                                  LOCATION 's3a://jon-emr2cdp/raw/wwbankdata/rawzone/finance/tax_2010';
...
CREATE EXTERNAL TABLE IF NOT EXISTS finance.tax_2015 (
                                 ...
                                 , local_tax INT
                                  ...
                                  FIELDS TERMINATED BY ','
                                  STORED AS TEXTFILE
                                  LOCATION 's3a://jon-emr2cdp/raw/wwbankdata/rawzone/finance/tax_2015';

CREATE DATABASE IF NOT EXISTS cost_savings COMMENT 'Cost Savings Database' LOCATION 's3a://jon-emr2cdp/raw/wwbankdata/rawzone/cost_savings';
...
CREATE EXTERNAL TABLE IF NOT EXISTS cost_savings.claim_savings(
                                   ...
                                   , Longitude DOUBLE
                                    ...
                                    FIELDS TERMINATED BY ','
                                    STORED AS TEXTFILE
                                    LOCATION 's3a://jon-emr2cdp/raw/wwbankdata/rawzone/cost_savings';


CREATE DATABASE IF NOT EXISTS claim COMMENT 'Claims Database' LOCATION 's3a://jon-emr2cdp/raw/wwbankdata/rawzone/claim';
...
CREATE EXTERNAL TABLE IF NOT EXISTS claim.provider_summary(
                                    ...
                                    , AverageMedicarePayments DECIMAL(10,2)
                                     ...
                                     FIELDS TERMINATED BY ','
                                     STORED AS TEXTFILE
                                     LOCATION 's3a://jon-emr2cdp/raw/wwbankdata/rawzone/claim';
...
CREATE DATABASE IF NOT EXISTS consent_master LOCATION 's3a://jon-emr2cdp/raw/wwbankdata/rawzone/consent';
...
CREATE EXTERNAL TABLE IF NOT EXISTS consent_master.consent_data(
                                  ...
                                  FIELDS TERMINATED BY ','
                                  STORED AS TEXTFILE
                                  LOCATION 's3a://jon-emr2cdp/raw/wwbankdata/rawzone/consent'
				  tblproperties("skip.header.line.count"="1");
...
CREATE DATABASE IF NOT EXISTS hr LOCATION 's3a://jon-emr2cdp/raw/wwbankdata/rawzone/hr';
...
CREATE EXTERNAL TABLE IF NOT EXISTS hr.employees(
                                  ...
                                  FIELDS TERMINATED BY ','
                                  STORED AS TEXTFILE
                                  LOCATION 's3a://jon-emr2cdp/raw/wwbankdata/rawzone/hr/employees'
                                  tblproperties("skip.header.line.count"="1");
